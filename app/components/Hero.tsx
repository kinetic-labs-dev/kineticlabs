...
export default function Hero() {
  ...
  return (
    <>
      <section
        style={{
          background: "#f5f5f7", /* Fondo clarito premium */
      ...
      >
        <style dangerouslySetInnerHTML={{__html: `
          ...
          @keyframes goldPulse {
            0%, 100% { color: #888; }
            50% { color: #D4AF37; } /* Pulsación en dorado */
          }
        ...
        <div
          style={{
            maxWidth: "1200px", margin: "0 auto", padding: "50px 20px", display: "flex", alignItems: "center", justifyContent: "center", gap: "10px", flexWrap: "wrap", boxSizing: "border-box", width: "100%", textAlign: "center"
          }}
        >
          ...
          <div style={{ flex: "1 1 100%", maxWidth: "100%", boxSizing: "border-box", display: "flex", flexDirection: "column", alignItems: "center" }}>
            ...
            <h1 style={{ fontWeight: "900", lineHeight: "1.1", marginBottom: "15px", letterSpacing: "-1px", width: "100%", boxSizing: "border-box" }}>
              ...
              <span style={{ fontSize: "clamp(32px, 9vw, 64px)", display: "block" }}>DE <span style={{ color: "#D4AF37" }}>ÉLITE</span></span> {/* Dorado */}
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", marginBottom: "10px", width: "100%" }}>
              ...
              <div style={{ display: "flex", gap: "10px", justifyContent: "center", flexWrap: "nowrap", width: "100%", maxWidth: "400px" }}>
                {/* Botón MÁS INFORMACIÓN (Borde Dorado) */}
                <button
                ...
                {/* Botón COMPRAR (Fondo Dorado, Texto Blanco) */}
                <a href="https://wa.me/34694296601" target="_blank" rel="noopener noreferrer" style={{ padding: "10px 16px", borderRadius: "50px", background: "#D4AF37", border: "2px solid #D4AF37", color: "#ffffff", textDecoration: "none", fontWeight: "bold", fontSize: "clamp(13px, 3.5vw, 16px)", transition: "all 0.3s ease", whiteSpace: "nowrap", flex: "1", textAlign: "center" }}>Comprar</a>
              </div>
            </div>
          </div>
          ...
          <div style={{ flex: "1.2 1 100%", position: "relative", height: "340px", display: "flex", alignItems: "center", marginTop: "10px", width: "100%", maxWidth: "100vw", boxSizing: "border-box" }}>
            ...
            {/* Animación dorada para las flechas */}
            {heroImages.length > 1 && (
      ...
      {/* POP-UP MODAL (Adaptado a tema claro) */}
      {isModalOpen && (
        <div 
          onClick={() => setIsModalOpen(false)} 
          style={{
            position: "fixed", top: 0, left: 0, width: "100vw", height: "100vh",
            background: "rgba(255, 255, 255, 0.8)", backdropFilter: "blur(10px)", /* Fondo claro borroso */
        ...
        >
          <div 
            ...
            style={{
              background: "#ffffff", border: "1px solid #e5e5ea", borderRadius: "24px", /* Caja blanca */
          ...
          >
            <button 
              onClick={() => setIsModalOpen(false)}
              style={{ position: "absolute", top: "20px", right: "20px", background: "#f5f5f7", border: "none", width: "32px", height: "32px", borderRadius: "50%", color: "#1d1d1f", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", transition: "background 0.2s" }}
            >
            ...
            <ul style={{ listStyle: "none", padding: 0, margin: "0 0 35px 0", display: "flex", flexDirection: "column", gap: "16px" }}>
              {[
                ...
                <li key={i} style={{ display: "flex", gap: "12px", alignItems: "flex-start" }}>
                  {/* Iconos de check en Dorado */}
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#D4AF37" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0, marginTop: "2px" }}>
            ...
            <button 
              onClick={() => setIsModalOpen(false)}
              style={{ width: "100%", padding: "16px", borderRadius: "12px", background: "#f5f5f7", border: "1px solid #e5e5ea", color: "#1d1d1f", fontSize: "16px", fontWeight: "bold", cursor: "pointer", transition: "all 0.2s ease" }}
            >
